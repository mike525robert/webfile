    ...
    return false;
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating"></label>
                          <input type="text" class="form-control" placeholder="Enter  5-10 digits HMT Code" name="pin" >
                        </div>
                      </div>
                    </div>
		 ...
		 <input type="text"  class="input-block-level" placeholder="Captcha" name="" required >
              ...
              <br><br>
                    ...
                    <button type="submit" name="submit" class="btn warning">Add HMT CODE Now</button>
            ...
            <div class="col-md-4">
              <div class="card card-profile"> 
                <div class="card-header card-header-primary">
                  <h4 class="card-title">List Of HMT Codes For My Bank</h4>
                  <p class="card-category">View account HMT Codes Avaliable</p>
                </div>
                <div class="card-body">
